...
<div class="col-md-18 col-18">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title text-center">Update Event</h4>
        </div>
        <div class="card-content">
            <div class="card-body">
                <form class="form form-horizontal" method="POST" action="{{ route('event.update', $event->id) }}">
                    @csrf
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-8 form-group">
                                <input type="text number" id="fee" value="{{$event->fee}}"
